...
# Заводим цикл, который будет считать четные и нечетные цифры до тех пор,
...
print(f"Количество четных цифр во введенном числе: {evens}")
print(f"Количество нечетных цифр во введенном числе: {odds}")
